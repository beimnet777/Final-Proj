...
# Missing 2x2 ablation cell:
#   dense temporal context = OFF
#   per-frame normalized reversed gradient = ON
#
# Every other training and probing setting matches job2_dense_gradnorm. This
# tests whether gradient normalization alone is sufficient, or whether Job 2
# needs the interaction between normalization and dense temporal context.
...
TRAIN_SEED=42
PROBE_SEED=42
RUN_NAME="job2_ablation_gradnorm_nodense"
...
echo "=== Job 2 ablation: normalized GRL without dense context ==="
