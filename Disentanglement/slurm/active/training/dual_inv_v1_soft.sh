...
#SBATCH --job-name=dual_inv_v1_soft
...
# v1 dual-invariance, SOFT learned routing (n_routes=2, no z_U, no GRL).
...
RUN_NAME="dual_inv_v1_soft"
CKPT_DIR="${DIS_DIR}/checkpoints/${RUN_NAME}"
STAGE2_CKPT="${CKPT_DIR}/stage2_best.pt"

echo "=== ${RUN_NAME}: dual-invariance v1, SOFT learned routing (n_routes=2) ==="
