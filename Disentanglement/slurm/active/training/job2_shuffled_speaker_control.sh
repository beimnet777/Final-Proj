...
# Negative control for Job 2. The z_P SID task keeps true speaker labels, while
# speaker adversaries receive deterministic random targets resampled each batch.
...
TRAIN_SEED=42
PROBE_SEED=42
RUN_NAME="job2_dense_gradnorm_shuffled_speaker"
...
echo "=== Job 2 shuffled-speaker negative control ==="
