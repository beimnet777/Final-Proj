...
# Diagnostic probe for the final projection checkpoint, not stage2_best.pt.
# stage2_best.pt was selected by reconstruction and corresponds to an early
# checkpoint for this run; this script probes the task-trained step-8000 model.
...
RUN_NAME="${RUN_NAME:-diag_probe_${MODEL_NAME}_step8000_zLP}"

SOURCES="${SOURCES:-z_L,z_P}"
TASKS="${TASKS:-pr,sid}"
